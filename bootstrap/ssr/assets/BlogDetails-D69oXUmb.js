...
function BlogDetails({ slug, seo }) {
	const articleTitle = seo?.title?.split(" | ")[0] || (slug ? slug.replace(/-/g, " ").replace(/\b\w/g, (l) => l.toUpperCase()) : "The Future of Enterprise Architecture: Serverless Meets Edge Computing");
	const metaDescription = seo?.description || "Discover how modern enterprises are leveraging edge computing and serverless architectures to reduce latency and cut costs.";
	return /* @__PURE__ */ jsxs(ThemeProvider, { children: [
		/* @__PURE__ */ jsxs(Head, { children: [
			/* @__PURE__ */ jsx("title", { children: `${articleTitle} | Zytrixon Tech Blog` }),
			/* @__PURE__ */ jsx("meta", {
				name: "description",
...
//# sourceMappingURL=BlogDetails-D69oXUmb.js.map
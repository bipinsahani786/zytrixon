...
//#region resources/js/components/about/AboutHeroEditorial.tsx
function AboutHeroEditorial() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", { style: {
			position: "absolute",
			inset: 0,
			backgroundImage: theme === "light" ? "linear-gradient(to right, rgba(0,0,0,0.03) 1px, transparent 1px), linear-gradient(to bottom, rgba(0,0,0,0.03) 1px, transparent 1px)" : "linear-gradient(to right, rgba(255,255,255,0.03) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,0.03) 1px, transparent 1px)",
			...
			children: [/* @__PURE__ */ jsx("h1", {
				...
				children: "We Engineer Digital Dominance for Enterprises Refusing Second Place."
			}), /* @__PURE__ */ jsxs("div", {
				style: {
					display: "grid",
				...
				children: [/* @__PURE__ */ jsx("p", {
					...
					children: "Founded in Bihar with a relentless engineering conviction, Zytrixon Tech designs and scales mission-critical cloud architectures, high-concurrency commerce engines, and zero-trust platforms."
				}), /* @__PURE__ */ jsx("p", {
					style: {
					...
					children: "We do not sell junior developer hours or generic templates. We build bespoke digital infrastructure designed to outlive market trends, sustain viral traffic surges, and compound enterprise valuation."
				})]
			})]
		})]
	});
				...
				children: [
					{
						...
						summary: "Zytrixon founded with an initial focus on distributed web APIs and micro-frontend architectures for Indian startups.",
						badge: "FOUNDING PHASE"
					},
					{
						year: "Q3 2022",
						title: "First International Architecture Audit",
						summary: "Commissioned by a Middle East logistics firm to audit high-throughput vehicle telematics pipelines, reducing memory leaks by 80%.",
						badge: "GLOBAL OUTREACH"
					},
					{
						year: "Q2 2023",
						title: "Thread Ax Headless Commerce Launch",
						summary: "Engineered sub-second Next.js storefront with atomic Redis flash sale checkout, handling over 25,000 simultaneous shoppers.",
						badge: "CONCURRENCY RECORD"
					},
					{
						year: "Q4 2023",
						title: "Smart India Detective Intelligence Portal",
						summary: "Architected zero-knowledge evidence submission suite and encrypted case vaults for India’s premier private investigation network.",
						badge: "ZERO-TRUST SECURITY"
					},
					{
						year: "Q2 2024",
						title: "ZytrixonLabs Pathology LIS 2.0",
						summary: "Built bidirectional ASTM/HL7 medical analyzer gateway, processing over 500k diagnostic reports with automated WhatsApp delivery.",
						badge: "HEALTHTECH MILESTONE"
					},
					{
						year: "Q4 2024",
						title: "NCR Operations & Land Portal Launch",
						summary: "Partnered with S.K. Infratech to launch direct-to-owner property acquisition engine with transparent RERA verification badges.",
						badge: "ENTERPRISE REAL ESTATE"
					},
					{
						year: "2025 - 2026",
						title: "Edge AI Agents & Distributed Telemetry",
						summary: "Expanding into autonomous multi-tenant agent orchestration and edge computing pipelines serving clients across 3 continents.",
						badge: "NEXT HORIZON"
					}
...
//#endregion
//#region resources/js/components/about/AboutCultureTalent.tsx
function AboutCultureTalent() {
	const { theme } = useTheme();
	const isLight = theme === "light";
	return /* @__PURE__ */ jsx("section", {
		id: "culture-talent",
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: "We optimize for uninterrupted craft, not calendar fragmentation."
					}), /* @__PURE__ */ jsx("p", {
						style: {
							fontSize: "16px",
							lineHeight: 1.7,
						...
						children: "World-class software cannot be conceived in 15-minute gaps between check-in calls. We built a culture designed specifically for senior systems thinkers: deep silence, high psychological safety, unapologetic curiosity, and extreme pride of authorship."
					})]
				}),
				/* @__PURE__ */ jsx("div", {
					style: {
					...
					children: [
						{
							...
							description: "We treat engineering attention as a non-renewable resource. Wednesdays and Fridays feature a company-wide moratorium on internal meetings. Zero standups, zero status pings—pure uninterrupted system crafting."
						},
						{
							number: "02",
							title: "Open Architectural RFCs",
							badge: "MERITOCRATIC DEBATE",
							description: "No technical hierarchy dictates schema design. Any developer—from junior associate to founder—can author an RFC document. Architectural choices succeed based on benchmarks and logic, never seniority."
						},
						{
							number: "03",
							title: "Annual Engineering Craft Stipend",
							badge: "CONTINUOUS EVOLUTION",
							description: "Every engineer receives an annual $1,500 allowance for specialized technical literature, advanced dev tools, local AI test hardware, and premier developer symposiums across India and internationally."
						},
						{
							number: "04",
							title: "100% In-House Direct Craft",
							badge: "ZERO OUTSOURCING",
							description: "We never pass client code down to anonymous third-party contractor networks. Every single route, query, and component is authored by full-time Zytrixon engineers trained in our security and performance tenets."
						}
					].map((tenet) => /* @__PURE__ */ jsxs("div", {
						style: {
							padding: "36px",
							borderRadius: "16px",
							border: "1px solid var(--zy-border-subtle)",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							...
							children: "AVG DAILY UNBROKEN FLOW BLOCK"
						})] }),
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							style: {
								fontFamily: "var(--font-heading, \"Space Grotesk\", sans-serif)",
							...
							children: "ANNUAL VOLUNTARY TALENT ATTRITION"
						})] }),
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							style: {
								fontFamily: "var(--font-heading, \"Space Grotesk\", sans-serif)",
							...
							children: "RATIO OF CODE TO MEETING TIME"
						})] }),
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							style: {
								fontFamily: "var(--font-heading, \"Space Grotesk\", sans-serif)",
							...
							children: "PERMANENT IN-HOUSE ARCHITECTS"
						})] })
					]
				})
			]
...
//#endregion
//#region resources/js/components/about/AboutEngagementModels.tsx
function AboutEngagementModels() {
	const { theme } = useTheme();
	const isLight = theme === "light";
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("h2", {
					...
					children: "Predictable engagements. Zero ambiguous change orders."
				}), /* @__PURE__ */ jsx("p", {
					style: {
						fontSize: "16px",
						lineHeight: 1.7,
					...
					children: "We despise typical agency billing traps—padding hourly invoices and holding source code hostage. We provide three battle-tested engagement models built around one objective: shipping resilient software that compounds your enterprise value."
				})]
			}), /* @__PURE__ */ jsx("div", {
				style: {
					display: "grid",
				...
				children: [
					{
						...
						popular: true,
						bestFor: "Funded ventures and product teams needing dedicated senior firepower.",
						features: [
					...
					},
					{
						...
						popular: false,
						bestFor: "Enterprises needing to replace slow legacy systems or rewrite monoliths.",
						features: [
					...
					},
					{
						...
						popular: false,
						bestFor: "High-traffic portals requiring 24/7 reliability and continuous performance.",
						features: [
					...
					style: {
						padding: "36px",
						borderRadius: "16px",
						border: m.popular ? isLight ? "2px solid #111111" : "2px solid #ffffff" : "1px solid var(--zy-border-subtle)",
						background: isLight ? "#ffffff" : "var(--zy-surface-1)",
						display: "flex",
						flexDirection: "column",
						gap: "20px",
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: m.features.map((feat, i) => /* @__PURE__ */ jsxs("div", {
								style: {
									display: "flex",
									alignItems: "baseline",
									gap: "10px",
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							...
							children: "COORDINATES: 25.5941° N, 85.1376° E • EST. 2022"
						})]
					})
				]
			})
...
function About() {
	return /* @__PURE__ */ jsxs(ThemeProvider, { children: [
		...
		/* @__PURE__ */ jsxs("main", { children: [
			/* @__PURE__ */ jsx(AboutHeroEditorial, {}),
			...
			/* @__PURE__ */ jsx(LazySection, { children: /* @__PURE__ */ jsx(AboutCultureTalent, {}) }),
			...
			/* @__PURE__ */ jsx(LazySection, { children: /* @__PURE__ */ jsx(AboutEngagementModels, {}) }),
...
//# sourceMappingURL=About-BFIcxDxU.js.map
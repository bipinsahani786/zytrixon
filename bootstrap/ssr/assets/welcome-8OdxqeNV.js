...
function LazySection({ children, minHeight = "50vh", threshold = 0, rootMargin = "50px 0px" }) {
...
function HeroSection() {
	...
	useEffect(() => {
		...
		import("@react-three/fiber").then((fiber) => {
			...
			return import("./iot-device-mesh-C8x7e9oC.js");
		}).then((meshModule) => {
...
var LazyAboutSection = lazy(() => import("./about-section-CTuiUVj4.js"));
var LazyStatsSection = lazy(() => import("./stats-section-C0azNZDO.js"));
var LazyServicesSection = lazy(() => import("./services-section-DBNwpFeD.js"));
var LazyIndustriesSection = lazy(() => import("./industries-section-BSqwFe1U.js"));
var LazyProcessSection = lazy(() => import("./process-section-bt_wzoCm.js"));
...
var LazyTeamSection = lazy(() => import("./team-section-DF7u0y6c.js"));
...
//# sourceMappingURL=welcome-8OdxqeNV.js.map
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [expanded && /* @__PURE__ */ jsxs("div", {
			...
			style: {
				...
				height: 56,
				borderRadius: "50%",
				background: expanded ? "#333" : "#25D366",
				border: "none",
				display: "flex",
				alignItems: "center",
				justifyContent: "center",
				cursor: "pointer",
				boxShadow: expanded ? "0 4px 20px rgba(0,0,0,0.3)" : "0 4px 20px rgba(37, 211, 102, 0.3)",
				transition: "all 0.3s ease",
				transform: expanded ? "rotate(45deg)" : "rotate(0)",
				animation: expanded ? "none" : "wa-pulse 8s ease-in-out infinite"
			},
...
//# sourceMappingURL=whatsapp-float-DrYWXU_u.js.map
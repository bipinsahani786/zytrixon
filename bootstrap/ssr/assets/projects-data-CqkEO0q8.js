//#region resources/js/lib/projects-data.ts
var DUMMY_PROJECTS = [
	{
		id: "sk-infratech",
		slug: "sk-infratech",
		...
		tagline: "Direct-to-buyer property inventory, RERA-verified land acquisition, and transparent property trading with ₹0 brokerage.",
		...
		solution: "Zytrixon engineered a high-speed, mobile-first real estate portal with instant inquiry routing, interactive plot catalogs, RERA verification documentation badges, and direct WhatsApp / telephony connect with acquisition heads.",
		solutionPoints: [
		...
		screenshots: [
			{
				...
				description: "Modern dark aesthetic hero section showcasing verified prime properties in Raj Nagar Extension with direct owner inventory."
			},
			{
				title: "The Pillars of Trust — Leadership Team",
				category: "Workflow",
				image: "/assets/projects/sk-infratech/team-pillars-trust.jpg",
				description: "Executive team profiles highlighting Sandeep Tyagi (Founder & CEO), Rajeev Tyagi (Acquisition Manager), and Pawan Tyagi (Sales & ROI Specialist)."
			},
			{
				title: "Premium Hot Deals Catalog",
				category: "Dashboard",
				image: "/assets/projects/sk-infratech/property-deals.jpg",
				description: "Curated residential plots, luxury 3BHK apartments, and high-ROI commercial opportunities with verified registration statuses."
			},
			{
				title: "Diverse Property Portfolio Matrix",
				category: "Analytics",
				image: "/assets/projects/sk-infratech/portfolio-stats.jpg",
				description: "Interactive categorization of plots, flats, agri land, farmhouses, and industrial projects with transparent key performance stats."
			},
			{
				title: "Client Testimonials & Verification",
				category: "Workflow",
				image: "/assets/projects/sk-infratech/client-testimonials.jpg",
				description: "Authentic buyer reviews and testimonials from verified clients and families highlighting hassle-free paperwork."
			}
		],
		features: [
			{
	...
	},
	{
		...
		tagline: "Encrypted client reporting, tamper-proof forensic evidence logging, and military-grade confidential client portals.",
		...
		summary: "Smart India Detective is a leading private investigation agency with pan-India operations. Zytrixon architected an end-to-end zero-trust digital infrastructure, offering encrypted evidence submission, confidential inquiry routing, and secure client reporting with automated tamper-proofing.",
		challenge: "Client confidentiality is paramount in corporate investigation. Traditional communication channels carried severe risks of data intercept, eavesdropping, and unauthorized leakage of sensitive legal or matrimonial evidence.",
		challengePoints: [
		...
		solution: "Zytrixon developed an end-to-end encrypted investigation management suite with client consultation routing, zero-knowledge evidence encryption, and automated NDA sign-offs.",
		solutionPoints: [
		...
		techStack: [
			...
			{
				name: "PostgreSQL",
				category: "Encrypted Persistence"
			},
			{
				name: "AWS KMS",
		...
		screenshots: [{
			...
			description: "Official homepage and confidential investigation request portal for Smart India Detective."
		}],
		features: [
			{
	...
	},
	{
		...
		tagline: "Modern headless storefront delivering sub-second checkout, automated warehouse fulfillment, and dynamic inventory sync.",
		...
		summary: "Thread Ax is a fast-growing contemporary fashion and streetwear label. Zytrixon built a high-performance headless e-commerce ecosystem capable of handling viral flash sales, automated warehouse dispatch, and sub-second checkout experiences.",
		...
		solution: "Zytrixon re-engineered the platform using Next.js 15 App Router, Redis atomic inventory locks, and automated Shiprocket / Delhivery fulfillment webhooks.",
		solutionPoints: [
		...
		techStack: [
			...
			},
			{
				...
				category: "Cart & Order Engine"
			},
			{
				name: "Redis Cache & Queues",
				category: "Flash Sale Locks"
			},
			{
		...
		screenshots: [{
			...
			description: "Live storefront showcasing unisex oversized hoodies, Dodge Charger drops, and rapid checkout."
		}],
		features: [
			{
	...
	},
	{
		...
		tagline: "The all-in-one cloud LIS platform. Connect analyzers, manage partners, and automate reporting with zero paper friction.",
		...
		solution: "Zytrixon architected an integrated cloud LIS with automated bidirectional ASTM/HL7 analyzer interfacing, digital signature approval queues, and instant WhatsApp/SMS report delivery.",
		solutionPoints: [
		...
		techStack: [
			...
			{
				name: "Laravel API",
				category: "Core LIS Engine"
			},
			{
				name: "HL7 & ASTM Protocols",
				category: "Analyzer Interfacing"
			},
			{
				name: "WhatsApp Business API",
		...
		screenshots: [{
			...
			description: "Live modern laboratory management portal showing Next-Gen LIS 2.0, lab telemetry, and diagnostic analytics."
		}],
		features: [
			{
...
//#endregion
export { getProjectBySlug as n, DUMMY_PROJECTS as t };

//# sourceMappingURL=projects-data-CqkEO0q8.js.map
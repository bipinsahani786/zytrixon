...
var DUMMY_PROJECTS = [
	...
	},
	{
		...
		videoUrl: "",
		videoPoster: "",
		summary: "Thread Ax is a fast-growing contemporary fashion and streetwear label. Zytrixon built a high-performance Laravel e-commerce ecosystem capable of handling viral flash sales, automated warehouse dispatch, and sub-second checkout experiences.",
		...
		solution: "Zytrixon re-engineered the platform using a robust Laravel 11 architecture, Redis atomic inventory locks, and automated Shiprocket / Delhivery fulfillment webhooks.",
		solutionPoints: [
		...
		techStack: [
			{
				name: "Laravel 11",
				category: "Core Backend Framework"
			},
			{
				name: "React 19 & Next.js",
...
//# sourceMappingURL=projects-data-B4c2Adyp.js.map
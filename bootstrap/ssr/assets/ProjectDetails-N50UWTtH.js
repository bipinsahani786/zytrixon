...
import { n as getProjectBySlug, t as DUMMY_PROJECTS } from "./projects-data-CqkEO0q8.js";
import { t as GradientCard } from "./GradientCard-44MI0y-Q.js";
			...
			navItems.map((item) => {
				...
				return /* @__PURE__ */ jsx("a", {
					...
					style: {
						...
						textDecoration: "none",
						color: isActive ? "#000000" : "var(--zy-text-secondary)",
					...
					children: project.screenshots.map((ss, idx) => {
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							style: {
								...
								border: isSelected ? `1px solid ${project.accentColor}` : "1px solid var(--zy-border-subtle)",
								cursor: "pointer",
								transition: "all 0.25s ease"
							},
							onMouseEnter: (e) => {
							...
							children: [
									...
									children: [
										/* @__PURE__ */ jsx("div", {
											...
											children: /* @__PURE__ */ jsx("span", {
												style: {
													fontSize: "11px",
													color: isSelected ? project.accentColor : "var(--zy-text-muted)",
													fontWeight: 800,
													textTransform: "uppercase"
												},
								...
								/* @__PURE__ */ jsx("div", {
									style: {
										...
										background: isSelected ? project.accentColor : "var(--zy-surface-2)",
										color: isSelected ? "#000000" : "var(--zy-text-secondary)",
										fontSize: "11px",
										fontWeight: 800
									},
									children: idx + 1
...
//# sourceMappingURL=ProjectDetails-N50UWTtH.js.map
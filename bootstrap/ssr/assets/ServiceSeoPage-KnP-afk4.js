import { i as CustomCursor, n as FooterCTA, o as ThemeProvider, r as Footer, s as useTheme, t as Navbar } from "./navbar-zs2JAPVG.js";
...
import { a as getServiceConfig, i as DevelopmentMethodology, n as QAAndTesting, r as ProcessTimeline, t as SecurityStandards } from "./SecurityStandards-D4BeNl0h.js";
import React, { useEffect, useRef, useState } from "react";
import { Fragment as Fragment$1, jsx, jsxs } from "react/jsx-runtime";
import { Activity, Battery, Bell, Bot, Box, Brain, Clock, Cloud, Code, Cpu, CreditCard, Database, DollarSign, Edit, Eye, Fingerprint, GitCommit, Globe, HardDrive, Layers, Link, Maximize, MessageSquare, Monitor, Network, PieChart, Repeat, Search, Server, Share2, Shield, Smartphone, Split, Target, TrendingUp, Users, Wifi, WifiOff, Zap } from "lucide-react";
import { Canvas, useFrame } from "@react-three/fiber";
//#region resources/js/components/sections/CaseStudiesList.tsx
function CaseStudiesList({ caseStudies = [] }) {
	if (!caseStudies || caseStudies.length === 0) return null;
	return /* @__PURE__ */ jsx("section", {
		className: "zy-section bg-background border-t border-border/50 py-20 px-6 sm:px-10",
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(SectionHeader, {
				...
				children: caseStudies.map((study) => /* @__PURE__ */ jsx(CaseStudyCard, { study }, study.id || study.slug))
			})]
		})
	});
}
...
function BlogPreviewSection({ service }) {
	const isSEO = service?.slug === "digital-marketing" || service?.slug === "seo-digital-marketing";
	const dummyBlogs = [
		{
			slug: isSEO ? "top-10-seo-strategies-for-2026" : "the-future-of-enterprise-architecture",
			title: isSEO ? "Top 10 SEO Strategies for 2026" : `The Future of ${service?.title || "Enterprise Technology"}`,
		...
		},
		{
			...
			excerpt: "Scaling your business requires resilient distributed architecture, enterprise security, and high performance.",
			date: "June 28, 2026",
		...
		},
		{
			...
			excerpt: "Learn how our clients achieve 10x ROI and 99.99% reliability within the first year of production partnership.",
			date: "June 15, 2026",
			category: "Business",
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(SectionHeader, {
				...
				className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",
				children: dummyBlogs.map((blog, i) => /* @__PURE__ */ jsx(BlogCard, { post: blog }, i))
			})]
		})
	});
}
...
//# sourceMappingURL=ServiceSeoPage-KnP-afk4.js.map
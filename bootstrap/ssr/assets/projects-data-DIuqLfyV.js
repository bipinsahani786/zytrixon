...
var DUMMY_PROJECTS = [
	{
		...
		tagline: "Not Just Brokers. We Are Partners — \"Trust is our Capital.\" Direct property owners & investors across Raj Nagar Extension & West UP with ₹0 brokerage and verified registry-ready titles.",
		...
		screenshots: [
			{
				...
				description: "Modern real estate showcase featuring verified prime properties in Raj Nagar Extension with direct owner inventory and ₹0 brokerage."
			},
			{
				title: "The Minds of Trust — Leadership Team",
				category: "Workflow",
				image: "/assets/projects/sk-infratech/team-pillars-trust.jpg",
				description: "Core leadership team: Sandeep Tyagi (Founder & CEO), Rajeev Tyagi (Acquisition Manager), Pawan Tyagi (Sales & ROI Specialist), and Neha Gupta (Customer Success)."
			},
			{
				title: "Prime Deals & Registry-Ready Portfolio",
				category: "Dashboard",
				image: "/assets/projects/sk-infratech/property-deals.jpg",
				description: "Verified Residential Plots, 3BHK Luxury Flats, Farmhouses, and High-ROI Agricultural & Industrial Lands with full registry status."
			},
			{
				title: "Dominance Across West UP Hubs",
				category: "Analytics",
				image: "/assets/projects/sk-infratech/portfolio-stats.jpg",
				description: "Strategic market dominance across RRTS Corridor (Duhai-Ghaziabad), Raj Nagar Extension, and Delhi-NCR Expressway Hubs with 500+ unit footprint."
			},
			{
				title: "Director Message & Client Verification",
				category: "Workflow",
				image: "/assets/projects/sk-infratech/client-testimonials.jpg",
				description: "\"Trust is our Capital\" — Authentic client testimonials and director commitment to complete transparency in West UP real estate."
			}
		],
		features: [
			{
	...
	},
	{
		...
		tagline: "All Types of Secret & Private Investigation In India & Abroad — Surveillance, Matrimonial, Corporate Fraud, Cyber Inquiry, and Court-Admissible Evidence with 100% Discretion.",
		...
		mobileImage: "/assets/projects/smart-india-detective/smart-india-mobile.png",
		...
		techStack: [
			...
			},
			{
				...
				category: "Zero-Trace Frontend"
			},
			{
				name: "MySQL Enterprise",
				category: "Encrypted Database"
			},
			{
				name: "Laravel Sanctum",
				category: "Secure Session Shield"
			}
		],
		screenshots: [{
			...
			description: "Official homepage and confidential investigation request portal for Smart India Detective delivering complete detective services personal & business."
		}, {
			title: "Mobile Case Intake & Rapid Response",
			category: "Mobile App",
			image: "/assets/projects/smart-india-detective/smart-india-mobile.png",
			description: "Mobile-first responsive investigation interface enabling 24/7 emergency hotline connect, encrypted evidence submission, and immediate WhatsApp dispatch."
		}],
		features: [
			{
	...
	},
	{
		...
		tagline: "Premium 280GSM+ heavyweight oversized streetwear with sub-second checkout, automated warehouse dispatch, and Pan-India delivery.",
		...
		videoUrl: "",
		videoPoster: "",
		summary: "ThreadAX is India's fastest-growing premium streetwear brand, crafting bold oversized apparel, hoodies, and heavyweight 280GSM cotton essentials. Zytrixon engineered a high-velocity Laravel D2C commerce platform featuring sub-second edge rendering, Redis atomic cart reservation, Razorpay payments, and automated Pan-India shipping.",
		challenge: "Viral TikTok & Instagram drop spikes caused database lock contention, cart abandonments, and inventory overselling across limited-edition hoodies and graphic oversized tees. ThreadAX needed an ultra-fast storefront with automated 7-day returns and real-time courier tracking.",
		challengePoints: [
		...
		solution: "Zytrixon re-engineered the complete commerce engine using Laravel 11, Redis atomic locks, optimized Next.js/Blade storefront caching, Razorpay instant checkout, and automated Shiprocket/Delhivery logistics dispatch.",
		solutionPoints: [
		...
		screenshots: [{
			...
			description: "Explore the complete ThreadAX D2C storefront — 280GSM+ heavyweight oversized essentials, Menswear & Womenswear collections, Dodge Velocity drops, verified buyer reviews, and Razorpay checkout."
		}],
		features: [
			{
...
//# sourceMappingURL=projects-data-DIuqLfyV.js.map
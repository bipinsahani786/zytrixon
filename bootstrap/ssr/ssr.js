...
* @route '/portfolio'
*/
portfolioForm.head = (options) => ({
	action: portfolio.url({ [options?.mergeQuery ? "mergeQuery" : "query"]: {
		_method: "HEAD",
		...options?.query ?? options?.mergeQuery ?? {}
	} }),
	method: "get"
...
* @route '/team'
*/
teamForm.head = (options) => ({
	action: team.url({ [options?.mergeQuery ? "mergeQuery" : "query"]: {
		_method: "HEAD",
		...options?.query ?? options?.mergeQuery ?? {}
	} }),
	method: "get"
...
* @route '/careers'
*/
careersForm.head = (options) => ({
	action: careers.url({ [options?.mergeQuery ? "mergeQuery" : "query"]: {
		_method: "HEAD",
		...options?.query ?? options?.mergeQuery ?? {}
	} }),
	method: "get"
...
* @route '/process'
*/
var process$1 = (options) => ({
	url: process$1.url(options),
	method: "get"
});
...
* @route '/process'
*/
process$1.url = (options) => {
	return process$1.definition.url + queryParams(options);
};
/**
* @see \Inertia\Controller::__invoke
* @see vendor/inertiajs/inertia-laravel/src/Controller.php:13
...
* @route '/process'
*/
processForm.head = (options) => ({
	action: process$1.url({ [options?.mergeQuery ? "mergeQuery" : "query"]: {
		_method: "HEAD",
		...options?.query ?? options?.mergeQuery ?? {}
	} }),
	method: "get"
});
process$1.form = processForm;
/**
* @see \Inertia\Controller::__invoke
* @see vendor/inertiajs/inertia-laravel/src/Controller.php:13
...
var renderPage = (page) => createInertiaApp({
	...
	resolve: async (name) => {
		const pageModule = await resolvePageComponent(`./pages/${name}.tsx`, /* #__PURE__ */ Object.assign({
			"./pages/About.tsx": () => import("./assets/About-aGzEZfTg.js"),
			"./pages/Blog.tsx": () => import("./assets/Blog-CFbWMAAg.js"),
			"./pages/BlogDetails.tsx": () => import("./assets/BlogDetails-D69oXUmb.js"),
			"./pages/Careers.tsx": () => import("./assets/Careers-C0ocQuj7.js"),
			"./pages/CaseStudiesIndex.tsx": () => import("./assets/CaseStudiesIndex-d6aXEPZX.js"),
			"./pages/CaseStudyDetails.tsx": () => import("./assets/CaseStudyDetails-BLShnK-B.js"),
			"./pages/Contact.tsx": () => import("./assets/Contact-B9rY_o0e.js"),
			"./pages/Error.tsx": () => import("./assets/Error-BnaQ7ZA-.js"),
			"./pages/LocationDetails.tsx": () => import("./assets/LocationDetails-D3ehzs4N.js"),
			"./pages/LocationsIndex.tsx": () => import("./assets/LocationsIndex-CAPN_zHX.js"),
			"./pages/Portfolio.tsx": () => import("./assets/Portfolio-BuxAGBL_.js"),
			"./pages/PrivacyPolicy.tsx": () => import("./assets/PrivacyPolicy-BIrjc12z.js"),
			"./pages/Process.tsx": () => import("./assets/Process-mfsO4Cs6.js"),
			"./pages/ServiceSeoPage.tsx": () => import("./assets/ServiceSeoPage-KnP-afk4.js"),
			"./pages/ServicesIndex.tsx": () => import("./assets/ServicesIndex-Bc7-H6Mn.js"),
			"./pages/Team.tsx": () => import("./assets/Team-BQQ96TFQ.js"),
			"./pages/TermsConditions.tsx": () => import("./assets/TermsConditions-D7fbiB0j.js"),
			...
			"./pages/welcome.tsx": () => import("./assets/welcome-5RJhxTnW.js")
		}));
		const defaultExport = pageModule.default;
		if (defaultExport && defaultExport.layout === void 0) switch (true) {
			case name === "welcome" || name === "ServiceSeoPage" || name === "ServicesIndex" || name === "LocationsIndex" || name === "LocationDetails" || name === "About" || name === "Portfolio" || name === "Contact" || name === "Team" || name === "Blog" || name === "Careers" || name === "Process" || name === "BlogDetails" || name === "CaseStudiesIndex" || name === "CaseStudyDetails" || name === "Error" || name === "PrivacyPolicy" || name === "TermsConditions":
	...
	setup: ({ App, props }) => /* @__PURE__ */ jsx(TooltipProvider, {
		delayDuration: 0,

    ...
    public function run(): void
    {
        $caseStudies = [
            [
                ...
                'results' => json_encode(['99.99% Uptime', '3x Faster Checkout', '40% Increase in Conversions']),
            ...
            [
                ...
                'results' => json_encode(['60% Reduced Admin Time', '0 Double Bookings', '15k+ Monthly Bookings']),
            ...
            [
                ...
                'results' => json_encode(['25% Fuel Cost Reduction', '98% On-Time Deliveries', '4.8 App Store Rating']),
            ...
            [
                ...
                'results' => json_encode(['500k Active Students', 'Zero Buffering Issues', '300% Growth in Subscriptions']),
            ...
            [
                ...
                'results' => json_encode(['450% Organic Traffic Boost', '#1 Rank for 50+ Keywords', '2x Lead Generation']),
            ...
            [
                ...
                'results' => json_encode(['$5M+ Processed Monthly', '2-Min KYC Time', 'Zero Security Breaches']),
            ...
            [
                ...
                'results' => json_encode(['30% Commission Saved', '10k+ App Installs', 'Loyalty Program Success']),
            ...
            [
                ...
                'results' => json_encode(['40% Less Machine Downtime', 'Real-time Alerts', '15% Production Boost']),

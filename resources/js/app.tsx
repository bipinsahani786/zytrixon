        ...
        if (defaultExport && defaultExport.layout === undefined) {
            switch (true) {
                ...
                case name.startsWith('auth/'):
                    defaultExport.layout = (page: any) => <AuthLayout children={page} />;
                    break;
                case name.startsWith('settings/'):
                    defaultExport.layout = (page: any) => <AppLayout><SettingsLayout children={page} /></AppLayout>;
                    break;
                default:
                    defaultExport.layout = (page: any) => <AppLayout children={page} />;
                    break;
            }
        }
        return pageModule;

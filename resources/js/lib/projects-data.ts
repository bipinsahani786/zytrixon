...
export const DUMMY_PROJECTS: ProjectItem[] = [
    {
        ...
        tagline:
            'Transforming academic administration with real-time analytics, automated fees, and smart student portals.',
        ...
        videoPoster:
            'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1400&q=85',
        summary:
            'CloudScale LMS is a comprehensive, multi-tenant academic ERP designed for schools, colleges, and university networks. It seamlessly consolidates student lifecycles, automated fee collection, biometric attendance tracking, and parent communication into one blazing-fast, unified cloud interface.',
        challenge:
            'The institution was burdened by legacy on-premise software that suffered from severe downtime during peak examination periods. Manual fee reconciliation led to accounting errors, and parents lacked real-time visibility into student attendance and performance metrics.',
        challengePoints: [
        ...
        solution:
            'Zytrixon engineered a modern cloud-native architecture using Next.js 15, high-performance Laravel APIs, and PostgreSQL with database sharding. We integrated direct UPI/card payment webhooks, automated WhatsApp notification queues, and an encrypted parent-teacher portal.',
        solutionPoints: [
        ...
        screenshots: [
            {
                ...
                description:
                    'Real-time overview of total enrollment, revenue collection, campus attendance rate, and upcoming academic milestones.',
            },
            {
                ...
                description:
                    'Automated batch invoice generation, pending installment alerts, online checkout portals, and instant ledger auditing.',
            },
            {
                ...
                description:
                    'Customizable grading rubrics, automated GPA computation, report card generation, and student performance analytics.',
            },
            {
                ...
                description:
                    'Responsive mobile portal allowing parents to track homework, view live bus GPS tracking, and chat directly with teachers.',
            },
        ],
        features: [
            {
    ...
    },
    {
        ...
        tagline:
            'Next-generation industrial IoT hub streaming millisecond vehicle telematics, fuel analytics, and predictive maintenance.',
        ...
        mobileImage:
            'https://images.unsplash.com/photo-1526628953301-3e589a6a8b74?w=900&q=80',
        ...
        videoPoster:
            'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1400&q=85',
        summary:
            'NexusTrack IoT is an industrial-grade telematics and fleet intelligence command center. It continuously streams telemetry data from thousands of connected vehicles, heavy construction equipment, and smart factory sensors, detecting anomalies and route delays in real time.',
        challenge:
            'The logistics operator faced mounting fuel theft, frequent highway mechanical breakdowns, and delayed client delivery updates due to fragmented 2G GPS trackers and laggy tracking software.',
        challengePoints: [
        ...
        solution:
            'Zytrixon developed an ultra-scalable MQTT and WebSocket telemetry pipeline capable of processing 25,000 events/second. Paired with a reactive Mapbox dashboard, automated geofence triggers, and machine-learning anomaly detection for predictive maintenance.',
        solutionPoints: [
        ...
        screenshots: [
            {
                ...
                description:
                    'Real-time interactive geospatial map tracking fleet positions, active speed, cargo temperature, and transit ETA.',
            },
            {
                ...
                description:
                    'Telemetry readings for engine oil temperature, RPM, tire pressure, and battery voltage with automatic threshold alarms.',
            },
            {
                ...
                description:
                    'Ultrasonic fuel sensor analytics revealing fuel consumption trends, refueling events, and sudden drop alarms.',
            },
            {
                ...
                description:
                    'Mobile workflow app for vehicle pre-trip checklists, digital proof of delivery, and turn-by-turn commercial route guidance.',
            },
        ],
        features: [
            {

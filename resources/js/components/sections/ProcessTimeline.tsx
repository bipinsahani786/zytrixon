        ...
        <section className="zy-section" style={{ background: isLight ? '#FFFFFF' : 'var(--zy-black)' }}>
            <div style={{ maxWidth: 1000, margin: '0 auto' }}>
                <div style={{ textAlign: 'center', marginBottom: 60 }}>
                    ...
                    <p style={{ color: isLight ? '#666' : 'var(--zy-gray-text)', marginTop: 16 }}>A transparent, agile process guaranteed to yield results.</p>
                </div>
                    ...
                    {[
                        ...
                        <div key={i} style={{ display: 'flex', gap: 32, marginBottom: 40, position: 'relative' }}>
                            ...
                            <div style={{ paddingTop: 12 }}>
                                ...
                                <p style={{ color: isLight ? '#555' : 'var(--zy-gray-text)', fontSize: 16, lineHeight: 1.6 }}>{item.desc}</p>
                            </div>
                        </div>
                    ))}
                </div>

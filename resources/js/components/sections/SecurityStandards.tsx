        ...
        <section className="zy-section" style={{ background: isLight ? '#fdfdfd' : 'var(--zy-black)', position: 'relative', overflow: 'hidden' }}>
            <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', gap: 60, alignItems: 'center', flexWrap: 'wrap' }}>
                <div style={{ flex: '1 1 400px' }}>
                    <span className="zy-section-label" style={{ color: '#3b82f6', opacity: 1 }}>Enterprise Security</span>
                    ...
                    <ul style={{ listStyle: 'none', padding: 0 }}>
                        {['End-to-End Encryption (AES-256)', 'SOC 2 Type II Compliance', 'GDPR & HIPAA Readiness', 'Automated Penetration Testing'].map((item, i) => (
                            <li key={i} style={{ 
                                ...
                                <div style={{ 
                                    width: 32, height: 32, borderRadius: '50%', background: '#3b82f620', 
                                    display: 'flex', alignItems: 'center', justifyContent: 'center' 
                                }}>
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                                </div>
                                {item}
                            </li>
                        ))}
                ...
                <div style={{ flex: '1 1 400px', minHeight: 450, position: 'relative' }}>
                    <GradientCard themeColor="#3b82f6">
                        <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', padding: 40, background: isLight ? '#f7f7f7' : 'transparent', borderRadius: 12 }}>
                            ...
                            {/* Glowing Center */}
                            <div style={{ position: 'absolute', width: 120, height: 120, background: '#3b82f6', filter: 'blur(70px)', opacity: isLight ? 0.2 : 0.35 }} />
                            ...
                            <div style={{ 
                                ...
                                boxShadow: isLight ? '0 10px 40px rgba(59, 130, 246, 0.15)' : '0 10px 40px rgba(0,0,0,0.5)'
                            }}>
                            ...
                            <div style={{ 
                                ...
                                background: isLight ? '#fff' : 'rgba(255,255,255,0.05)', borderRadius: 24, 
                                border: `1px solid ${isLight ? '#eee' : 'rgba(255,255,255,0.1)'}`, fontSize: 13, fontWeight: 700, 
                                color: '#3b82f6', backdropFilter: 'blur(5px)',
                                boxShadow: isLight ? '0 4px 15px rgba(0,0,0,0.05)' : '0 4px 15px rgba(0,0,0,0.3)'
                            }}>
                                AES-256
                            </div>

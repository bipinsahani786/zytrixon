...
export default function HeroDynamic({ service, location, h1 }: any) {
    ...
    return (
        <section style={{ 
            ...
            {/* 3D Background */}
            <div style={{ position: 'absolute', inset: 0, zIndex: 0, opacity: isLight ? 0.3 : 1 }}>
            ...
            <div style={{ maxWidth: 1000, margin: '0 auto', position: 'relative', zIndex: 1, pointerEvents: 'none' }}>
                <div style={{ display: 'flex', justifyContent: 'center', gap: 12, marginBottom: 32 }}>
                    <span style={{ 
                        padding: '6px 16px', background: `${themeColor}1a`, color: themeColor, 
                    ...
                    {location && (
                        <span style={{ 
                            padding: '6px 16px', background: 'rgba(34, 197, 94, 0.1)', color: '#22c55e', 
                            borderRadius: 50, fontSize: 13, fontWeight: 700, letterSpacing: '0.05em',
                            border: '1px solid rgba(34, 197, 94, 0.2)', backdropFilter: 'blur(5px)'
                        }}>
                ...
                <h1 style={{ 
                    ...
                    lineHeight: 1.1, marginBottom: 32, fontFamily: 'var(--font-heading)',
                ...
                <div style={{ display: 'flex', gap: 16, justifyContent: 'center', pointerEvents: 'auto', flexWrap: 'wrap' }}>
                    <button className="zy-btn-primary" style={{ 
                    ...
                    <button className="zy-btn-outline" style={{ 

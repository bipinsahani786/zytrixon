...
export default function ServiceEstimator({ service }: any) {
    ...
    const calculateEstimate = () => {
        const base = service?.slug === 'ai-automation' ? 10000 : 5000;
        let multiplier = 1;
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Tell us about your requirements and get an instant ballpark
                    estimate for your {service?.title || 'project'}. No emails
                    required.
                </p>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="high">
                                            High (Machine Learning, Real-time)
                                        </option>
                                        <option value="custom">
                                            Extreme (Custom Protocols, Hardware)
                                        </option>
                                    </select>
                                </div>
                                <div>
                            ...
                            >
                                ...
                                >
                                    *This is a ballpark estimate. Final cost
                                    will be determined after discovery phase.
                                </p>
                            </div>
                        </div>
                    </div>

            ...
            <div style={{ maxWidth: 1200, margin: '0 auto' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: 32 }}>
                    {caseStudies.map((study: any) => (
                        <Link href={`/case-studies/${study.slug}`} key={study.id} style={{ display: 'block', textDecoration: 'none' }}>
                            <GradientCard style={{ textAlign: 'left', height: '100%' }}>
                                ...
                                <div style={{ padding: 32, flex: 1, display: 'flex', flexDirection: 'column' }}>
                                    <div style={{ color: 'var(--zy-blue)', fontSize: 13, fontWeight: 700, marginBottom: 12, letterSpacing: '0.05em', textTransform: 'uppercase' }}>
                                        {study.industry}
                                    </div>
                                    <h3 style={{ fontSize: 22, fontWeight: 700, color: 'var(--zy-white)', marginBottom: 16, fontFamily: 'var(--font-heading)', lineHeight: 1.3 }}>
                                        {study.title}
                                    </h3>
                                    <p style={{ color: 'var(--zy-gray-text)', lineHeight: 1.6, marginBottom: 24, fontSize: 14 }}>
                ...
                <div style={{ textAlign: 'center', marginTop: 40 }}>
                    <Link href="/case-studies" className="zy-btn-outline" style={{ color: 'var(--zy-white)', borderColor: 'rgba(255,255,255,0.2)' }}>

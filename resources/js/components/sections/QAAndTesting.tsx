                    ...
                    <GradientCard themeColor="#10b981">
                        <div style={{ 
                            ...
                            <div style={{ 
                                ...
                                <span style={{ marginLeft: 16, fontSize: 13, color: isLight ? '#666' : '#888', fontFamily: 'monospace' }}>
                            ...
                            <div style={{ padding: 32, display: 'flex', flexDirection: 'column', gap: 20 }}>
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                                                <div style={{ 
                                                    ...
                                                    {isPassed ? (
                                                        ...
                                                        <div style={{ width: 6, height: 6, borderRadius: '50%', background: isLight ? '#ccc' : '#444' }} />
                                                    )}
                                                </div>
                                                <span style={{ 
                                ...
                                <div style={{ marginTop: 12 }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8, fontSize: 13, color: isLight ? '#666' : '#888', fontFamily: 'monospace' }}>
                                        <span>Test Suite Progress</span>
                                        <span>{Math.min(100, Math.floor(progress / 100 * 100))}%</span>
                                    </div>

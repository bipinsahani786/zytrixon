...
export default function ProjectNextTeaser({ project, otherProject }: ProjectNextTeaserProps) {
    const { theme } = useTheme();
    const isLight = theme === 'light';

    return (
        <section style={{ padding: '0 var(--zy-section-pad-x, 24px) 110px', maxWidth: '1240px', margin: '0 auto' }}>
            ...
            <div
                style={{
                    ...
                    border: isLight ? `1px solid ${project.accentColor}50` : `1px solid ${project.accentColor}40`,
                    borderRadius: '26px',
                    padding: '56px 44px',
                    display: 'flex',
                    flexWrap: 'wrap',
            ...
            >
                <div style={{ maxWidth: '680px' }}>
                    ...
                    <p style={{ color: isLight ? '#555555' : '#a0a0a0', fontSize: '15px', marginTop: '10px', lineHeight: 1.6 }}>
                        Directly interact with the live production deployment. Test attendance check-ins, simulated payment webhooks, and multi-tenant portals.
                    </p>
                </div>
            ...
            >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    <Link
                        ...
                        onMouseLeave={(e) => (e.currentTarget.style.color = isLight ? '#555555' : '#777777')}
                    >
                        ← Return to All Projects
                    </Link>

                    <span style={{ fontSize: '12px', color: isLight ? '#777777' : '#666666', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                        Up Next
                    </span>
                </div>
                ...
                <Link
                    ...
                    onMouseEnter={(e) => {
                        e.currentTarget.style.borderColor = otherProject.accentColor;
                        e.currentTarget.style.transform = 'translateY(-4px)';
                        e.currentTarget.style.boxShadow = `0 20px 50px ${otherProject.accentColor}20`;
                    }}
                    onMouseLeave={(e) => {
                        e.currentTarget.style.borderColor = isLight ? '1px solid rgba(0, 0, 0, 0.08)' : 'rgba(255, 255, 255, 0.1)';
                        e.currentTarget.style.transform = 'translateY(0)';
                        e.currentTarget.style.boxShadow = isLight ? '0 10px 30px rgba(0,0,0,0.04)' : 'none';
                    }}
                >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '20px' }}>
                        <div>
                            ...
                            <p style={{ color: isLight ? '#555555' : '#888888', fontSize: '14px', marginTop: '6px', maxWidth: '600px' }}>

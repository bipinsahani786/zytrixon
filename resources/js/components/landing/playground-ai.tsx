...
export default function PlaygroundAI() {
    ...
    useEffect(() => {
        if (status === 'done') {
            const fullText =
                'Analysis complete. Detected 3 optimization opportunities in workflow. Automated script generated to reduce manual entry by 85%.';
            let i = 0;
        ...
        >
            ...
            >
                <div>
                    ...
                    <p style={{ fontSize: 13, color: 'var(--zy-gray-text)' }}>
                        Simulate an automated workflow analysis
                    </p>
                </div>
                <button
                    ...
                    style={{
                        ...
                        fontWeight: 600,
                        cursor:
                            status === 'analyzing' ? 'not-allowed' : 'pointer',
                        fontSize: 13,
                        transition: 'all 0.3s',
                    }}
                >

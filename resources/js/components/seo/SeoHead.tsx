...
export default function SeoHead({ seo, service, location }: any) {
    ...
    if (service) {
        schemaOrgJSONLD.push({
            ...
            '@type': 'BreadcrumbList',
            'itemListElement': [
                { '@type': 'ListItem', 'position': 1, 'name': 'Home', 'item': 'https://zytrixontech.com' },
                { '@type': 'ListItem', 'position': 2, 'name': 'Services', 'item': 'https://zytrixontech.com/services' },
                { '@type': 'ListItem', 'position': 3, 'name': service.title, 'item': `https://zytrixontech.com/services/${service.slug}` }
            ]
        } as any);
    }
    ...
    return (
        <Head>
            ...
            <meta name="keywords" content={`Software Company ${locName}, Web Development ${locName}, App Development, IoT, Zytrixon, Best IT Company ${locState}, India IT Agency`} />

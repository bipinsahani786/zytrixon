 ...
 */
const showServiceLocationf6d09d9092eb835f4a0aff152ee549d3 = (
    args:
        | { service_slug: string | number }
        | [service_slug: string | number]
        | string
        | number,
    options?: RouteQueryOptions,
 ...
 * @route '/services/{service_slug}'
 */
showServiceLocationf6d09d9092eb835f4a0aff152ee549d3.url = (
    args:
        | { service_slug: string | number }
        | [service_slug: string | number]
        | string
    ...
    return (
        showServiceLocationf6d09d9092eb835f4a0aff152ee549d3.definition.url
 ...
 * @route '/services/{service_slug}'
 */
showServiceLocationf6d09d9092eb835f4a0aff152ee549d3.get = (
    args:
        | { service_slug: string | number }
        | [service_slug: string | number]
        | string
 ...
 * @route '/services/{service_slug}'
 */
showServiceLocationf6d09d9092eb835f4a0aff152ee549d3.head = (
    args:
        | { service_slug: string | number }
        | [service_slug: string | number]
        | string
 ...
 * @route '/services/{service_slug}'
 */
const showServiceLocationf6d09d9092eb835f4a0aff152ee549d3Form = (
    args:
        | { service_slug: string | number }
        | [service_slug: string | number]
        | string
    ...
    action: showServiceLocationf6d09d9092eb835f4a0aff152ee549d3.url(
        args,
        options,
    ),
    method: 'get',
 ...
 * @route '/services/{service_slug}'
 */
showServiceLocationf6d09d9092eb835f4a0aff152ee549d3Form.get = (
    args:
        | { service_slug: string | number }
        | [service_slug: string | number]
        | string
 ...
 * @route '/services/{service_slug}'
 */
showServiceLocationf6d09d9092eb835f4a0aff152ee549d3Form.head = (
    args:
        | { service_slug: string | number }
        | [service_slug: string | number]
        | string
...
showServiceLocationf6d09d9092eb835f4a0aff152ee549d3.form =
    showServiceLocationf6d09d9092eb835f4a0aff152ee549d3Form;
/**
 * @see \App\Http\Controllers\SeoController::showServiceLocation
 * @see app/Http/Controllers/SeoController.php:43
 * @route '/services/{service_slug}/in/{location_slug}'
 */
const showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaa = (
    args:
        | { service_slug: string | number; location_slug: string | number }
        | [service_slug: string | number, location_slug: string | number],
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
 ...
 * @route '/services/{service_slug}/in/{location_slug}'
 */
showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaa.url = (
    args:
        | { service_slug: string | number; location_slug: string | number }
        | [service_slug: string | number, location_slug: string | number],
    options?: RouteQueryOptions,
    ...
    return (
        showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaa.definition.url
            .replace('{service_slug}', parsedArgs.service_slug.toString())
            .replace('{location_slug}', parsedArgs.location_slug.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
 ...
 * @route '/services/{service_slug}/in/{location_slug}'
 */
showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaa.get = (
    args:
        | { service_slug: string | number; location_slug: string | number }
        | [service_slug: string | number, location_slug: string | number],
    options?: RouteQueryOptions,
 ...
 * @route '/services/{service_slug}/in/{location_slug}'
 */
showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaa.head = (
    args:
        | { service_slug: string | number; location_slug: string | number }
        | [service_slug: string | number, location_slug: string | number],
    options?: RouteQueryOptions,
 ...
 * @route '/services/{service_slug}/in/{location_slug}'
 */
const showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaaForm = (
    args:
        | { service_slug: string | number; location_slug: string | number }
        | [service_slug: string | number, location_slug: string | number],
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaa.url(
        args,
        options,
    ),
    method: 'get',
 ...
 * @route '/services/{service_slug}/in/{location_slug}'
 */
showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaaForm.get = (
    args:
        | { service_slug: string | number; location_slug: string | number }
        | [service_slug: string | number, location_slug: string | number],
    options?: RouteQueryOptions,
 ...
 * @route '/services/{service_slug}/in/{location_slug}'
 */
showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaaForm.head = (
    args:
        | { service_slug: string | number; location_slug: string | number }
        | [service_slug: string | number, location_slug: string | number],
    options?: RouteQueryOptions,
...
showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaa.form =
    showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaaForm;
...
export const showServiceLocation = {
    '/services/{service_slug}':
        showServiceLocationf6d09d9092eb835f4a0aff152ee549d3,
    '/services/{service_slug}/in/{location_slug}':
        showServiceLocation13ce03ebdeb54ae9f497a8c08b92bfaa,
};

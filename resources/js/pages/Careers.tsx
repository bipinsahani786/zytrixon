            ...
            <main style={{ minHeight: '100vh', background: 'var(--zy-black)', overflowX: 'hidden' }}>
                ...
                <section style={{ padding: '80px 24px', maxWidth: 1200, margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: 60 }}>
                        <h2 style={{ fontSize: 'clamp(32px, 5vw, 48px)', fontFamily: 'var(--font-heading)', fontWeight: 800, color: 'var(--zy-white)', marginBottom: 24 }}>Open Positions</h2>
                        <p style={{ color: 'var(--zy-gray-text)', fontSize: 18, maxWidth: 600, margin: '0 auto' }}>Explore our current openings and find where you fit in.</p>
                    </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                        {jobs.map((job) => (
                            ...
                            onMouseEnter={(e) => { e.currentTarget.style.borderColor = 'var(--zy-blue)'; e.currentTarget.style.transform = 'translateX(10px)'; }}
                            onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'var(--zy-gray-border)'; e.currentTarget.style.transform = 'translateX(0)'; }}
                            >
                                <div>
                                    <h3 style={{ fontSize: 24, fontWeight: 700, color: 'var(--zy-white)', marginBottom: 12 }}>{job.title}</h3>
                                    <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', color: 'var(--zy-gray-text)', fontSize: 14 }}>
                                ...
                                <a href="mailto:zytrixon@gmail.com" className="magnetic-btn" style={{ padding: '12px 32px', fontSize: 14 }}>
                                    Apply Now
                                </a>
                            </div>
                        ))}
